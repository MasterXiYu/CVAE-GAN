...
class generator(nn.Module):
	...
	def __init__(self, d=128):
		...
		self.deconv1_1 = nn.ConvTranspose2d(in_channels=100,out_channels=d*4,kernel_size=4,stride=1,padding=0)
		self.deconv1_1_bn = nn.BatchNorm2d(d*4)
		# it do not use RElu??
		self.deconv1_2 = nn.ConvTranspose2d(in_channels=2, out_channels=d * 4, kernel_size=4, stride=1, padding=0)
		...
		self.deconv5 = nn.ConvTranspose2d(in_channels=d, out_channels=3, kernel_size=4, stride=2, padding=1)
		self.deconv1_1 = nn.ConvTranspose2d(in_channels=100, out_channels=d * 4, kernel_size=4, stride=1, padding=0)
		# self.deconv1_1_bn = nn.BatchNorm2d(d * 4)
